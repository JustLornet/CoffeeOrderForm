...
{
    [DbContext(typeof(Db))]
    [Migration("20230225091224_AddOrderCreatRealization")]
    partial class AddOrderCreatRealization
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("MyTestAppBack.Domain.Aggregates.CoffeeIngredient", b =>
                {
                    ...
                    b.ToTable("dictCoffeeIngredients");
            ...
            modelBuilder.Entity("MyTestAppBack.Domain.Aggregates.CustomComposition", b =>
                {
                    ...
                    b.HasIndex("CoffeeIngredientId", "Value")
                        .IsUnique();
            ...
            modelBuilder.Entity("MyTestAppBack.Domain.Aggregates.CoffeeOrder", b =>
                {
                    b.HasOne("MyTestAppBack.Domain.Aggregates.CoffeeSyrup", "CoffeeSyrup")
                        .WithMany("CoffeeOrders")
                        .HasForeignKey("CoffeeSyrupId");
